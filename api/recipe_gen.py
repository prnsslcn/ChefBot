...
samples = [
    {
        "input": "피카소",
        "output": "메뉴이름: 피카소 스타일 푸드 아트\n"
        "재료: 다양한 색상의 소스, 접시, 붓\n"
        "조리법: 피카소 스타일 푸드 아트 만드는 방법\n"
        "1. 다양한 색상의 소스를 준비합니다.\n"
    ...
    {
        "input": "우주 여행",
        "output": "메뉴이름: 우주 비행사용 우주식품\n"
        "재료: 동결 건조된 음식, 진공 포장 재료\n"
        "조리법: 우주 비행사들이 먹는 우주식품 만드는 방법\n"
    ...
    {
        "input": "올림픽",
        "output": "메뉴이름: 올림픽 선수 맞춤 고단백 식단\n"
        "재료: 닭가슴살, 퀴노아, 채소, 견과류\n"
        "조리법: 올림픽 선수들이 즐겨 먹는 고단백 식단\n"
    ...
    {
        "input": "AI 기술",
        "output": "메뉴이름: AI 맞춤형 건강 레시피\n"
        "재료: 사용자 맞춤 영양 분석 데이터, 식재료 리스트\n"
        "조리법: AI가 추천하는 맞춤형 음식 레시피\n"
    ...
    {
        "input": "해리포터",
        "output": "메뉴이름: 해리포터 버터맥주\n"
        "재료: 우유, 버터, 바닐라 시럽, 카라멜, 크림\n"
        "조리법: 해리포터 속 버터맥주 만드는 방법\n"
    ...
    {
        "input": "NFT",
        "output": "메뉴이름: NFT 테마 디저트\n"
        "재료: 마카롱, 3D 프린팅 초콜릿, 식용 색소\n"
        "조리법: NFT 테마 디저트 만들기\n"
    ...
    },
    {
        "input": "여행 가방",
        "output": "메뉴이름: 여행용 간편식\n"
        "재료: 견과류, 건과일, 에너지바, 즉석 식사팩\n"
        "조리법: 여행 중 간편하게 먹을 수 있는 음식 준비법\n"
    ...
    {
        "input": "일론 머스크",
        "output": "메뉴이름: 미래형 지속 가능 식단\n"
        "재료: 인공 고기, 식물성 우유, 곤충 단백질\n"
        "조리법: 일론 머스크가 추천하는 미래형 음식\n"
    ...
    {
        "input": "고흐의 별이 빛나는 밤",
        "output": "메뉴이름: 고흐의 별이 빛나는 밤 디저트\n"
        "재료: 블루베리 파이, 레몬 커드, 아이싱, 초콜릿 별 장식\n"
        "조리법: 고흐의 별이 빛나는 밤을 닮은 디저트 만들기\n"
